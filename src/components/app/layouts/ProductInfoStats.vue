    ...
    <div class="table-filters">
        <ul>
            <li id="stats_filter_toggle" @click.prevent="doMenu('stats_filter_toggle')">
                <a href="#" :class="{ 'dropdown-out' : toggleFilter }" @click.prevent="doMenu('stats_filter_toggle')">
                Last 7 days
...
<teleport to="body">
    ...
    <transition :name="getMobile? 'slide' : ''">
        <div class="menu-dropdown dropdown" v-if="toggleFilter" :class="[{ 'show-menu' : toggleFilter && !getMobile}, { 'menu-card-mob': getMobile}]" :style="{ left: !getMobile? getFloatingDiv.left-70+'px' : '', top: !getMobile? getFloatingDiv.top+45 + 'px' : ''}">
            ...
            <ul>
                <li><a href="#" class="flex-row-js" :class="{ 'is-sorted' : filters.id == 1 }" @click.prevent="doSort(1, 'Newest')"><span>Last 7 days</span><svg xmlns="http://www.w3.org/2000/svg" height="13" viewBox="0 0 27.028 19.354"><path d="M301.593,2748.482l-9.772-9.461,2.087-2.155,7.652,7.409,15.169-15.146,2.12,2.123Z" transform="translate(-291.821 -2729.128)" fill="#566ff4"></path></svg></a></li>
                <li><a href="#" class="flex-row-js" :class="{ 'is-sorted' : filters.id == 2 }" @click.prevent="doSort(2, 'Oldest')"><span>Last 30 days</span><svg xmlns="http://www.w3.org/2000/svg" height="13" viewBox="0 0 27.028 19.354"><path d="M301.593,2748.482l-9.772-9.461,2.087-2.155,7.652,7.409,15.169-15.146,2.12,2.123Z" transform="translate(-291.821 -2729.128)" fill="#566ff4"></path></svg></a></li>
                <li><a href="#" class="flex-row-js" :class="{ 'is-sorted' : filters.id == 3 }" @click.prevent="doSort(3, 'Sort A-Z')"><span>Last 60 days</span><svg xmlns="http://www.w3.org/2000/svg" height="13" viewBox="0 0 27.028 19.354"><path d="M301.593,2748.482l-9.772-9.461,2.087-2.155,7.652,7.409,15.169-15.146,2.12,2.123Z" transform="translate(-291.821 -2729.128)" fill="#566ff4"></path></svg></a></li>
                <li><a href="#" class="flex-row-js" :class="{ 'is-sorted' : filters.id == 4 }" @click.prevent="doSort(4, 'Sort Z-A')"><span>Last 90 days</span><svg xmlns="http://www.w3.org/2000/svg" height="13" viewBox="0 0 27.028 19.354"><path d="M301.593,2748.482l-9.772-9.461,2.087-2.155,7.652,7.409,15.169-15.146,2.12,2.123Z" transform="translate(-291.821 -2729.128)" fill="#566ff4"></path></svg></a></li>
            </ul>
        </div>
    </transition>
</teleport>
