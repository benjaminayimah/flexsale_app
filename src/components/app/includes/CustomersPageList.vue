    ...
    <li>
        <a href="">
            <div class="image-hold">
                <div class="bg-img" v-if="customer.image" :style="{backgroundImage: 'url('+require('@/assets/images/profiles/'+customer.image)+')'}"></div>
            ...
            <div class="flex-row-js info-section-hold">
                ...
                <div class="menu-toggle">
                    <button class="menu-toggle-btn" :id="'customer_menu_'+customer.id" @click.prevent="doMenu('customer_menu_'+customer.id)">
                        <i></i>
                        <i></i>
                        <i></i>
                    </button>
        ...
        <transition :name="getMobile? 'slide' : ''">
            <div class="menu" v-if="toggleMenu" :class="[{ 'class-above' : classAbove && !getMobile}, { 'class-below' : !classAbove && !getMobile}, { 'menu-card-mob': getMobile}]">
                ...
                <ul @mouseup="dismissMenu">
                    <li><router-link :to="'/product/'+customer.id+'/'+customer.name">View details</router-link></li>
    ...
    computed: {
        ...
        computeInitials() {
            if(this.customer.image == '') {
                let name = this.customer.name.split(' ')
