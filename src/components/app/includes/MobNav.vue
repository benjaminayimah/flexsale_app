    ...
    <div id="mob_nav" v-if="getMobile">
        <div class="mob-nav-content">
            ...
            <router-link :to="{ name: 'Products', params: { id: 'all' , name: 'products'} }">
                <i>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 21 21.001">
            ...
            <router-link :to="'/sales-record/filter/todays-sales'">
                <i>
                <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 22.638 22.638">
                ...
                <li>
                    <a href="">
                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 20.136 23.003">
                            <path d="M-4174.068-411.993v-23h13.963l6.173,6.173v16.83Zm1.5-1.5h17.136v-14.27h-5.734V-433.5h-11.4Zm12.9-15.769h3.174l-3.174-3.174ZM-4170-418.994v-1.5h12.5v1.5Zm0-4v-1.5h12.5v1.5Zm0-4v-1.5h6.5v1.5Z" transform="translate(4174.068 434.996)"/>
                        </svg>
                        <span>Invoice</span>
                    </a>
                </li>
...
export default {
    ...
    computed: mapGetters(['getMobile', 'getFloatingDiv', 'getUser']),
    data() {
        return {
            showMenu: false
        }
