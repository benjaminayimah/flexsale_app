        ...
        <div class="li-hold">
            ...
            <div class="flex gap-4">
                <div class="flex align-items-center gap-4" v-if="!computeExpiry">
                    <label>Qty:</label>
                    <input type="text" v-model="quantity" class="form-control qty-input">
                </div>
                <button class="button uppercase gap-4">
                    <svg xmlns="http://www.w3.org/2000/svg" width="11" height="11" viewBox="0 0 11.41 11.41">
