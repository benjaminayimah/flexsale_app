        ...
        <div v-if="getOAuthModal.active" class="floating-container">
            <div class="floating-wrap flex-col gap-32">
                ...
                <div class="flex-col align-items-center justify-content-center">
                    <div>
                        <svg v-if="getOAuthModal.type == 'google'" xmlns="http://www.w3.org/2000/svg" height="30" viewBox="0 0 31.341 32.021">
                        ...
                        <svg v-else-if="getOAuthModal.type == 'facebook'" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="30" viewBox="0 0 32.021 31.86">
                            <defs>
