      ...
      <div class="container-fluid">
          <div class="container">
              <div class="login-wrapper">
                  <header>
                      <svg id="large-logo" xmlns="http://www.w3.org/2000/svg" width="197.728" height="34.823" viewBox="0 0 197.728 34.823">
                    ...
                    <svg id="mini-logo" xmlns="http://www.w3.org/2000/svg" width="80" height="80" viewBox="0 0 386 386">
                        ...
                        <rect width="386" height="386" rx="193" transform="translate(750 810)" fill="#fff"/>
                        <path d="M114.208-1118.587l-.114-.119,55.723-55.724a28.624,28.624,0,0,0,8.439-20.376,28.624,28.624,0,0,0-8.439-20.372L106.994-1278h29.793a15.376,15.376,0,0,1,10.866,4.5l50.17,50.636c16.5,17.995,11.709,46.115-.809,57.223l-46.874,47.056c-3,3-10.485,4.5-17.966,4.5S117.208-1115.588,114.208-1118.587ZM68.5-1121.464,2.084-1187.8A7.085,7.085,0,0,1,0-1192.822v-77.324a7.1,7.1,0,0,1,7.1-7.1H84.424a7.1,7.1,0,0,1,5.02,2.08l66.415,66.419a.052.052,0,0,1,.017.014,22.412,22.412,0,0,1,6.558,15.907,22.418,22.418,0,0,1-6.558,15.907l-.017.016-55.439,55.44a22.421,22.421,0,0,1-15.962,6.612A22.429,22.429,0,0,1,68.5-1121.464Z" transform="translate(838.862 2199.105)" fill="#4a85f5"/>
                        </g>
                    </svg>
