        ...
        <div class="left-hold flex">
          <div class="left-content">
            <div>
              <div id="logo">
                <a href="">
                  <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" height="25" viewBox="0 0 197.728 34.823">
                  <defs>
                    <linearGradient id="linear-gradient" x1="0.767" y1="0.941" x2="0.02" y2="0.036" gradientUnits="objectBoundingBox">
                      <stop offset="0" stop-color="#5871f8"/>
                      <stop offset="1" stop-color="#33a7f0"/>
                    </linearGradient>
                  </defs>
                  <g id="Group_3413" data-name="Group 3413" transform="translate(-54.944 -670.846)">
                    <path id="Path_1646" data-name="Path 1646" d="M24.264,33.867l-.024-.025L36.078,22a6.121,6.121,0,0,0,0-8.657L22.731,0h6.33A3.267,3.267,0,0,1,31.37.956L42.028,11.713c3.5,3.824,2.488,9.8-.172,12.158l-9.959,10c-.638.637-2.227.956-3.817.956S24.9,34.5,24.264,33.867Zm-9.711-.611L.443,19.163A1.508,1.508,0,0,1,0,18.1V1.669A1.508,1.508,0,0,1,1.509.161H17.936A1.508,1.508,0,0,1,19,.6L33.113,14.714l0,0a4.794,4.794,0,0,1,0,6.759l0,0L21.334,33.257a4.793,4.793,0,0,1-6.782,0ZM3.017,17.471,16.686,31.124a1.777,1.777,0,0,0,2.516,0L30.978,19.348a1.78,1.78,0,0,0,0-2.5L17.311,3.177H3.017ZM6.79,12.083a4.827,4.827,0,1,1,5.379,4.2,4.877,4.877,0,0,1-.594.037A4.827,4.827,0,0,1,6.79,12.083Zm4.478-3.134a2.564,2.564,0,1,0,.314-.019A2.569,2.569,0,0,0,11.268,8.949Z" transform="translate(54.944 670.846)" fill="url(#linear-gradient)"/>
